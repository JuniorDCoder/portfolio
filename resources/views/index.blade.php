...
@section('content')
  ...
  <section id="hero"  style="background: url('{{$generalInfo ? asset('storage/' . $generalInfo->background_image) : asset('assets/img/hero-bg.jpg')}}') top center;" class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="hero-container" data-aos="fade-in">
      <h1>{{$aboutInfo ? $aboutInfo->full_name : 'Foryoung Junior Ngu'}}</h1>
      @php
         if ($aboutInfo) {
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ $aboutInfo ? date("jS F Y", strtotime($aboutInfo->birthday)) : '30th September 2004' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>{{$aboutInfo ? $aboutInfo->website : 'foryoungjunior.site'}}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>{{$aboutInfo ? $aboutInfo->phone : '+237677802114'}}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>{{$aboutInfo ? $aboutInfo->address : 'Bambili, Bamenda'}}</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>{{ $aboutInfo ? \Carbon\Carbon::parse($aboutInfo->birthday)->age : '27' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>{{$aboutInfo ? $aboutInfo->degree : 'MS in Computer Science'}}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>{{$aboutInfo ? $aboutInfo->email : 'foryoungjuniorngu@gmail.com'}}</span></li>
